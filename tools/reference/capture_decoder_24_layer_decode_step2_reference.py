...
REPORT_PATH = (
    PROJECT_DIR
    / "docs"
    / "decoder_24_layer_decode_step2_reference.json"
)
...
def main() -> None:
    ...
    print()
    print(
        "===== Capture Step 2 for all 24 layers ====="
    )
    ...
    report = {
        ...
        "step2_decode_seconds": decode_seconds,
        "token_contract": {
