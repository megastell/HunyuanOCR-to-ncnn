...
MODEL_DIR = (
    PROJECT_DIR
    / "artifacts/decoder_layer0_decode_step3"
)

PNNX_SCRIPT = (
    MODEL_DIR
    / "decoder_layer0_decode_step3_pnnx.py"
)

REFERENCE_DIR = (
    PROJECT_DIR
    / "reference/smoke_en_cpu_fp32"
    / "decoder_layer0_decode_step3"
)

REPORT_PATH = (
    PROJECT_DIR
    / "docs"
    / "decoder_layer0_decode_step3_pnnx_parity.json"
)
...
def load_generated_module() -> Any:
    ...
    specification = (
        importlib.util.spec_from_file_location(
            "decoder_layer0_decode_step3_pnnx",
            PNNX_SCRIPT,
        )
    )
...
def main() -> None:
    ...
    try:
        ...
        print()
        print(
            "===== PNNX Step 3 reference inference ====="
        )
